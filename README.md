...
Security teams face backlog and false-positive fatigue in **portfolio scaffolding**. This repo demonstrates a production-style **Shared Template** agent using **Multi**.

Shared Docker, Ollama, LLM factory, and CI skeleton for the Cyber AI Portfolio.
...
|---------|------------|------------------------|
| Shared Template | Core agent flow | Simple prompt chain |
